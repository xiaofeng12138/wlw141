<template>
    <div class="wrap">
        <BackHeader :configData = 'showTitle' style="showHeader"/>
         <div class="noInfo" v-if="arrVideoList.length == 0">
            <van-empty description="您还未上传视频~~" />
        </div>
       <div class="imgList" v-else  v-for="(item,index) in arrVideoList" :key="index"  >
...
import {queryVideoList,delVideo} from '@/api/login'
